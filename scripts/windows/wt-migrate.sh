...
#   wt-migrate --from-url https://github.com/your-org/backend.git
#   wt-migrate --from-url https://github.com/your-org/backend.git backend
...
Examples:
  ...
  wt-migrate --from-dir "C:/Seekout/AI-1099" AI-1099
  wt-migrate --from-url https://github.com/your-org/backend.git
  wt-migrate --from-url https://github.com/your-org/backend.git my-backend

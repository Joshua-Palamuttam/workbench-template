...
- `/skill-import commit` — Import "commit" skill from registry
- `/skill-import https://github.com/anthropics/skills/tree/main/.claude/skills/commit` — Import from GitHub
- `/skill-import /path/to/skill --global` — Import from local path and make global

...
```bash
cd "C:/worktrees-SeekOut/<repo>.git" && echo "y" | bash C:/worktrees-SeekOut/workbench/scripts/windows/wt-hotfix-pr.sh <PR#> --ticket <ticket> --release <branch> --quick [--dry-run]
```

...
4. Read `C:/worktrees-SeekOut/workbench/config.yaml` to get the list of repos. Ask the user via AskUserQuestion which repo to use (list repo names as options, max 4 most common + Other).

### Step 3: Run the Script

```bash
cd "C:/worktrees-SeekOut/<repo>.git" && bash C:/worktrees-SeekOut/workbench/scripts/windows/wt-feature.sh <branch-name> [base-branch]
```
